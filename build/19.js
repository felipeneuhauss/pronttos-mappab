...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ClinicsPageModule", function() { return ClinicsPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(49);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__clinics__ = __webpack_require__(532);
...
var ClinicsPageModule = /** @class */ (function () {
    function ClinicsPageModule() {
    }
    ClinicsPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["K" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__clinics__["a" /* ClinicsPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__clinics__["a" /* ClinicsPage */]), __WEBPACK_IMPORTED_MODULE_3__components_fake_fake_module__["a" /* FakeModule */]
            ],
        })
    ], ClinicsPageModule);
    return ClinicsPageModule;
}());
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ClinicsPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(49);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_clinics_clinics__ = __webpack_require__(287);
...
/**
 * Generated class for the ClinicsPage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var ClinicsPage = /** @class */ (function () {
    function ClinicsPage(navCtrl, navParams, clinicsPrv, modalCtrl) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.clinicsPrv = clinicsPrv;
        this.modalCtrl = modalCtrl;
        this.searching = false;
        this.getItems();
    }
    ClinicsPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad ClinicsPage');
    };
    ClinicsPage.prototype.getItems = function () {
        var _this = this;
        this.searching = true;
        this.clinicsPrv.query().subscribe(function (data) {
            _this.searching = false;
            _this.currentItems = data;
        });
    };
    ClinicsPage.prototype.addItem = function () {
        var _this = this;
        var detailModal = this.modalCtrl.create(__WEBPACK_IMPORTED_MODULE_3__index__["b" /* ClinicDetailPage */]);
    ...
    ClinicsPage.prototype.openItem = function (item) {
        var _this = this;
        var detailModal = this.modalCtrl.create(__WEBPACK_IMPORTED_MODULE_3__index__["b" /* ClinicDetailPage */], { item: item });
        detailModal.onDidDismiss(function (data) {
            if (data.reload) {
                _this.getItems();
            }
    ...
    ClinicsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-clinics',template:/*ion-inline-start:"/Users/felipeneuhauss/Workspace/mappabapp/src/pages/clinics/clinics.html"*/'<!--\n  Generated template for the ClinicsPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n    <ion-title>Clínicas</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content>\n  <card-fake *ngIf="searching"></card-fake>\n  <ion-list *ngIf="!searching">\n    <ion-card *ngFor="let item of currentItems" text-wrap>\n      <ion-card-content>\n        <h3>{{item.name}} </h3>\n        <p>\n          Localização: <strong>{{item.location}} </strong>\n        </p>\n        <p>\n          Contato: <strong>{{item.contact_name}} </strong>\n        </p>\n        <p>\n          Telefone: <strong>{{item.phone_number}} </strong>\n        </p>\n        <p>\n          Celular: <strong>{{item.mobile_number}} </strong>\n        </p>\n        <p>\n          E-mail: <strong>{{item.email}} </strong>\n        </p>\n      </ion-card-content>\n    </ion-card>\n  </ion-list>\n</ion-content>\n'/*ion-inline-end:"/Users/felipeneuhauss/Workspace/mappabapp/src/pages/clinics/clinics.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_2__providers_clinics_clinics__["a" /* ClinicsProvider */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* ModalController */]])
    ], ClinicsPage);
    return ClinicsPage;
}());
