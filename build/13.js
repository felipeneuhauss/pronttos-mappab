...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "HospitalSearchPageModule", function() { return HospitalSearchPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(49);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__hospital_search__ = __webpack_require__(542);
...
var HospitalSearchPageModule = /** @class */ (function () {
    function HospitalSearchPageModule() {
    }
    HospitalSearchPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["K" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__hospital_search__["a" /* HospitalSearchPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__hospital_search__["a" /* HospitalSearchPage */]), __WEBPACK_IMPORTED_MODULE_3__components_fake_fake_module__["a" /* FakeModule */]
            ],
        })
    ], HospitalSearchPageModule);
    return HospitalSearchPageModule;
}());

//# sourceMappingURL=hospital-search.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return HospitalSearchPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(49);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_hospitals_hospitals__ = __webpack_require__(294);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
 ...
 */
var HospitalSearchPage = /** @class */ (function () {
    function HospitalSearchPage(navCtrl, viewCtrl, hospitals, modalCtrl) {
    ...
    HospitalSearchPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad HospitalSearchPage');
        this.initializeItems();
    };
    HospitalSearchPage.prototype.initializeItems = function () {
        var _this = this;
        this.searching = true;
        this.hospitals.query().subscribe(function (data) {
            _this.searching = false;
            _this.originalItems = data;
            _this.currentItems = _this.originalItems;
        });
    };
    HospitalSearchPage.prototype.onCancel = function () {
        this.currentItems = this.originalItems;
    };
    HospitalSearchPage.prototype.getHospitals = function (ev) {
        ...
        if (val && val.trim() != '') {
            this.currentItems = this.originalItems.filter(function (item) {
                return item.mapper.name.toLowerCase().indexOf(val.toLowerCase()) >= 0;
            });
        }
    };
    HospitalSearchPage.prototype.selectHospital = function (item) {
        this.hospitalSelected = item;
    };
    HospitalSearchPage.prototype.dismiss = function () {
        this.viewCtrl.dismiss({ hospital: this.hospitalSelected });
    };
    HospitalSearchPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-hospital-search',template:/*ion-inline-start:"/Users/felipeneuhauss/Workspace/mappabapp/src/pages/hospitals/hospital-search/hospital-search.html"*/'<!--\n  Generated template for the HospitalSearchPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n    <ion-title>Pesquisa de hospitais</ion-title>\n    <ion-buttons end>\n      <button ion-button icon-only (click)="dismiss()">\n        <ion-icon name="md-close"></ion-icon>\n      </button>\n    </ion-buttons>\n  </ion-navbar>\n</ion-header>\n\n\n<ion-content>\n  <ion-searchbar\n    [(ngModel)]="hospitalName"\n    [placeholder]="\'Nome do hospital\'"\n    [showCancelButton]="true"\n    (ionInput)="getHospitals($event)"\n    (ionCancel)="onCancel($event)">\n  </ion-searchbar>\n  <ion-list radio-group [(ngModel)]="hospitalSelected">\n    <ion-item *ngFor="let item of currentItems">\n      <ion-label>\n        {{ item.name }} • {{ item.location }}\n      </ion-label>\n      <ion-radio [value]="item"></ion-radio>\n    </ion-item>\n  </ion-list>\n\n  <fake *ngIf="searching"></fake>\n\n  <ion-fab right bottom>\n    <button ion-fab  [disabled]="!hospitalSelected" (click)="dismiss()"><ion-icon name="checkmark"></ion-icon></button>\n  </ion-fab>\n</ion-content>\n'/*ion-inline-end:"/Users/felipeneuhauss/Workspace/mappabapp/src/pages/hospitals/hospital-search/hospital-search.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["r" /* ViewController */],
            __WEBPACK_IMPORTED_MODULE_2__providers_hospitals_hospitals__["a" /* HospitalsProvider */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* ModalController */]])
    ], HospitalSearchPage);
    return HospitalSearchPage;
}());

//# sourceMappingURL=hospital-search.js.map
