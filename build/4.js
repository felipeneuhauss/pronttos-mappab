...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SpecializationsPageModule", function() { return SpecializationsPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(49);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__specializations__ = __webpack_require__(574);
...
var SpecializationsPageModule = /** @class */ (function () {
    function SpecializationsPageModule() {
    }
    SpecializationsPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["K" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__specializations__["a" /* SpecializationsPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__specializations__["a" /* SpecializationsPage */]), __WEBPACK_IMPORTED_MODULE_3__components_fake_fake_module__["a" /* FakeModule */]
            ],
        })
    ], SpecializationsPageModule);
    return SpecializationsPageModule;
}());
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SpecializationsPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(49);
...
/**
 * Generated class for the SpecializationsPage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var SpecializationsPage = /** @class */ (function () {
    function SpecializationsPage(navCtrl, navParams, specializationsPrv, modalCtrl) {
    ...
    SpecializationsPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad SpecializationsPage');
    };
    SpecializationsPage.prototype.getItems = function () {
        var _this = this;
        this.searching = true;
    ...
    SpecializationsPage.prototype.addItem = function () {
        var _this = this;
        var specializationDetailModal = this.modalCtrl.create(__WEBPACK_IMPORTED_MODULE_2__index__["z" /* SpecializationDetailPage */]);
    ...
    SpecializationsPage.prototype.openItem = function (item) {
        var _this = this;
        var specializationDetailModal = this.modalCtrl.create(__WEBPACK_IMPORTED_MODULE_2__index__["z" /* SpecializationDetailPage */], { item: item });
        specializationDetailModal.onDidDismiss(function (data) {
            if (data.reload) {
                _this.getItems();
            }
    ...
    SpecializationsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-specializations',template:/*ion-inline-start:"/Users/felipeneuhauss/Workspace/mappabapp/src/pages/specializations/specializations.html"*/'<!--\n  Generated template for the SpecializationsPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n    <ion-title>Especializações</ion-title>\n    <ion-buttons end>\n      <button ion-button clear icon-only (click)="addItem()">\n        <ion-icon name="add"></ion-icon>\n      </button>\n    </ion-buttons>\n  </ion-navbar>\n\n</ion-header>\n\n<ion-content>\n  <fake *ngIf="searching"></fake>\n  <ion-list *ngIf="!searching">\n    <ion-item *ngFor="let item of currentItems" (click)="openItem(item)" text-wrap>\n      <h3>{{item.name}} </h3>\n    </ion-item>\n  </ion-list>\n</ion-content>\n\n'/*ion-inline-end:"/Users/felipeneuhauss/Workspace/mappabapp/src/pages/specializations/specializations.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_3__providers_specializations_specializations__["a" /* SpecializationsProvider */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* ModalController */]])
    ], SpecializationsPage);
